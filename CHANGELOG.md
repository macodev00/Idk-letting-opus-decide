...
- `--fix` generates LICENSE (10 licenses), CONTRIBUTING, CODE_OF_CONDUCT, SECURITY, issue forms, PR template, CI workflow, Dependabot config, .gitignore, CHANGELOG and AGENTS.md, tailored to the project's ecosystem, including CI workflows for Node, Python, Go, Rust, Java (Maven/Gradle), Ruby, PHP and .NET. Existing files are never overwritten.
