...
- 21 checks across legal, documentation, community, security and quality, with a weighted score and A–F grade.
...
- Secret scanner for 18 credential types with redacted output and inline ignore comments.
